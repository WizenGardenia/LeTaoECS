package cn.edu.cqu.letao.generator;
...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("just");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/ali99database?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("cn.edu.cqu.letao");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
